  ...
  const handleShorten = async () => {
    try {
      ...
      const response = await axios.post(
        "http://https://scissor-mbob.onrender.com/shorten-url",
        {
          original_url: url,
          id: user.id,
        },
      ...
      <Container maxWidth="md" className="container mt-14 text-white">
        ...
        >
          ...
          <span>
            <Typography
              variant="h2"
              className="inline text-toma topic-md"
              sx={{
                fontWeight: "bold",
              }}
            >
        ...
        <Box maxWidth="xl" className="mx-auto mt-4 mb-6 w-full">
          <Grid maxWidth="xl">
            <Grid>
              ...
              >
                Enter your long URL here to create a short link and generate QR
                code.
                <span>
                  <Typography
                    variant="h6"
                    sx={{ fontWeight: "light", fontSize: "16px" }}
                    className="inner-textsm"
                  >
                    Example:
                    http://www.theviennareview.at/archives/2013/the-two-faces-of-viennas-bermuda-triangle
                  </Typography>
                </span>
              </Typography>
            </Grid>
            <Grid maxWidth="xl" className="mx-auto w-full">
              <Card
                className="shadow appearance-none mt-2"
                ...
                <form className="my-4 w-full" onSubmit={handleFormSubmit}>
                  ...
                  >
                    <Box className="flex items-center gap-2 mx-auto">
                      <input
                        className="fields shadow appearance-none border rounded py-2 px-14 mx-auto leading-tight focus:outline-none focus:shadow-outline"
                        type="text"
                        name="url"
                        required
                        value={url}
                ...
                {shortenedUrl && qrCodeImage.imageUrl && (
                  ...
                  >
                    <Typography
                      ...
                      sx={{ fontWeight: "bold" }}
                      paragraph
                      className="w-full text-blu pb-2 inline"
                    >
                      Shortened URL: &emsp;
                      <span>
                        <Link
                        ...
                        >
                          <Typography
                            variant="h6"
                            sx={{ fontWeight: "light", color: "#ffffff" }}
                            paragraph
