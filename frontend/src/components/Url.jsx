  ...
  const handleUrl = async () => {
    try {
      ...
      const response = await axios.get(
        `https://scissor-mbob.onrender.com/original-url/${shortUrl}`
      );
              ...
              <Box maxWidth="xl" className="mx-auto mt-4 mb-6 w-full">
                <Grid maxWidth="xl">
                  <Grid>
                    ...
                    >
                      Enter the your Scissor shortened link to fetch the initial
                      url you shortened.
                      <span>
                        <Typography
                          variant="h6"
                              ...
                              <Card sx={{ backgroundColor: "transparent" }}>
                                <Container maxWidth="md" className="mt-12">
                                  <Typography
                                    variant="h5"
                                    sx={{ fontWeight: "bold" }}
                                    className="w-full text-blu text-center pb-2 inline"
                                  >
                                    Original URL: &emsp;
                                    <span>
                                      <Typography
