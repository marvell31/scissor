  ...
  const handleQr = async () => {
    try {
      ...
      const response = await axios.get(
        `https://scissor-mbob.onrender.com/get-qr/${shortUrl}`,
        {
              ...
              <Box maxWidth="xl" className="mx-auto mt-4 mb-6 w-full">
                <Grid maxWidth="xl">
                  <Grid>
                    ...
                    >
                      Enter the your Scissor shortened link to fetch the QR code
                      assigned to it.
                      <span>
                        <Typography
                          variant="h6"
                          sx={{ fontWeight: "light", fontSize: "16px" }}
                          className="inner-text-sm"
                        >
                    ...
                    >
                        ...
                        >
                          <Box className="flex items-center gap-2 mx-auto">
                            <input
                              ...
                              placeholder="Enter Scissor Link Here"
                            />
                            <Button
                      ...
                      {qr.imageUrl && (
                        <Grid>
                          <Box
                            maxWidth="sm"
                            className="border border-1 border-transparent bg-transparent w-full"
                          >
