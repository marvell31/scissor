...
export const RegisterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://scissor-mbob.onrender.com/register",
        formData,
        {
  ...
  return (
    <div className="h-screen mx-auto'">
      <h1 className="text-center text-3xl text-white hover:text-toma font-extrabold pt-6 pb-10">
        Register
      </h1>
      {flashMessage && (
      ...
      <form className="max-w-sm mx-auto w-full" onSubmit={handleSubmit}>
        <div className="flex flex-col pt-10">
          ...
          <label htmlFor="cpwd" className="text-white">
            Confirm Password
          </label>
          <div className="relative">
            <input
